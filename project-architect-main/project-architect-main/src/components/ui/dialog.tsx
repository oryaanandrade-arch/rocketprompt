...
>(({ className, children, hideOverlay = false, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed bottom-6 left-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] gap-4 border bg-card p-6 shadow-xl duration-300 data-[state=open]:animate-slide-up data-[state=closed]:animate-slide-down rounded-xl",
        className,
      )}
      {...props}
    >
